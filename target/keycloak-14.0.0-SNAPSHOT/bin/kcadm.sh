...
#else
#    java $KC_OPTS -cp $DIRNAME/client/keycloak-admin-cli-14.0.0-SNAPSHOT.jar org.keycloak.client.admin.cli.KcAdmMain "$@" --noconfig --token $(kcinit token admin-cli) --server $(kcinit show server)
#fi
